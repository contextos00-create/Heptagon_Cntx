...
export const ChatPanel: React.FC<ChatPanelProps> = ({
  ...
  if (!isOpen) {
    return (
      <button
        onClick={onOpen}
        className="fixed top-1/2 -translate-y-1/2 right-0 z-50 flex items-center gap-1.5 px-2 py-2.5 rounded-l-md bg-orange-500 hover:bg-orange-600 text-white shadow-lg transition-transform hover:scale-105 active:scale-95 group font-mono text-[11px] font-semibold cursor-pointer border-l border-y border-orange-600/40"
